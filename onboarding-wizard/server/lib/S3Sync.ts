...
/**
 * S3 Sync Utility for Onboarding Wizard
 *
 * Syncs user-validated data to S3 after onboarding completion using AWS CLI
 *
...
export class S3Sync {
   ...
   * @param s3SubPath - Sub-path under S3_PREFIX (e.g., "customer-output/123/user-validated")
